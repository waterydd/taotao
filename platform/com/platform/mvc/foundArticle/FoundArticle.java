...
@Table(tableName = FoundArticle.table_name,pkName = "id")
public class FoundArticle extends BaseModel<FoundArticle> {

	private static final long serialVersionUID = 4433600927099312344L;

	public static final FoundArticle dao = new FoundArticle();
	
	/**
	 * 表名
	 */
	public static final String table_name = "pre_Found_article";
	/**
	 * 分页SQL
	 */
	public static final String sqlId_splitPageFrom = "platform.FoundArticle.splitPageFrom";
