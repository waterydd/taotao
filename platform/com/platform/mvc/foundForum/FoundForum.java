...
@Table(tableName = FoundForum.table_name,pkName = "id")
public class FoundForum extends BaseModel<FoundForum> {

	private static final long serialVersionUID = 4433600927099312344L;

	public static final FoundForum dao = new FoundForum();
	
	/**
	 * 表名
	 */
	public static final String table_name = "pre_found_forum";
	/**
	 * 分页SQL
	 */
	public static final String sqlId_splitPageFrom = "platform.foundForum.splitPageFrom";
